...
EGGHUNTER=egghunter-sigaction2
SHELLCODE=shellcode
EGG=W00T
...
# Slightly modify the egg to make only 1 comparison
# Quic kand dirty python trick
EGG=`python -c "e='$EGG'; print chr(ord(e[0])+1)+e[1:]"`
